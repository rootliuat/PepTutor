...
export function matchesLabelSelector(selector: string, labels: Record<string, string>): boolean {
...
export function matchesLabelSelectors(selectors: string[], labels: Record<string, string>): boolean {
  return selectors.every(selector => matchesLabelSelector(selector, labels))
}

function getPeerLabels(peer: AuthenticatedPeer): Record<string, string> {
  return {
...
export function matchesDestination(destination: string | RouteTargetExpression, peer: AuthenticatedPeer): boolean {
...
export function matchesDestinations(destinations: Array<string | RouteTargetExpression>, peer: AuthenticatedPeer): boolean {
