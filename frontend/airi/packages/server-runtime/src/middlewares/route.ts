...
export type RoutedWebSocketEvent = WebSocketEvent<Record<string, unknown> | undefined>
...
export function collectDestinations(event: RoutedWebSocketEvent | (Omit<RoutedWebSocketEvent, 'metadata'> & Partial<Pick<RoutedWebSocketEvent, 'metadata'>>)) {
