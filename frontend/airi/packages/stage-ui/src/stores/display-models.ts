...
const presetLive2dProUrl = resolvePresetLive2dUrl(presetLive2dProAssetUrl, '/__airi/live2d/preset/hiyori_pro_zh')
const presetLive2dFreeUrl = resolvePresetLive2dUrl(presetLive2dFreeAssetUrl, '/__airi/live2d/preset/hiyori_free_zh')
