...
const isAuthenticated = computed(() => isLessonRoute.value ? false : ensureAuthStore().isAuthenticated)
const userName = computed(() => isLessonRoute.value ? undefined : ensureAuthStore().user?.name)
const userAvatar = computed(() => isLessonRoute.value ? undefined : ensureAuthStore().user?.image)
...
function openLoginDrawer() {
  ensureAuthStore().isLoginDrawerOpen = true
}
