...
| `docs/submission-project-book-final-draft-20260508.md` | Formal project-book draft for submission packaging. |
| `docs/submission-one-page-scorecard-20260508.md` | One-page scorecard for quick reviewer orientation. |
| `docs/submission-video-script-20260508.md` | 6-8 minute explanation video script. |
| `docs/submission-video-rehearsal-pack-20260508.md` | Timestamped video rehearsal pack with fallback lines. |
...
| `docs/submission-demo-risk-checklist-20260508.md` | Demo risk/fallback checklist. |
...
## Smoke Counts After The Docs-Only Delivery Commit
