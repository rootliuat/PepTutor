...
def compact_turn(
    *,
    ...
    return {
        ...
        "speech_style_tag": performance.get("speech_style_tag"),
        "target_role": performance.get("target_role"),
        "expected_student_action": performance.get("expected_student_action"),
