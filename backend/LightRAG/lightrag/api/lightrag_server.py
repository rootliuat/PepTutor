...
from lightrag.api.routers.lesson_routes import create_lesson_routes
from lightrag.api.routers.lesson_chat_history_routes import (
    create_lesson_chat_history_routes,
)
from lightrag.api.routers.ollama_api import OllamaAPI
from lightrag.api.speech_proxy_routes import create_speech_proxy_routes
from lightrag.orchestrator.lesson_runtime_factory import build_lesson_runtime
...
def create_app(args):
    ...
    async def lifespan(app: FastAPI):
        ...
        try:
            ...
            if lesson_runtime_bundle and lesson_runtime_bundle.close:
                lesson_runtime_bundle.close()
    ...
    try:
        lesson_runtime_bundle = build_lesson_runtime(
            workspace=args.workspace,
            embedding_func=embedding_func,
            llm_model_func=llm_model_func,
            llm_model_kwargs=llm_model_kwargs,
        ...
        logger.warning(f"Lesson routes disabled: {exc}")

    app.include_router(create_lesson_chat_history_routes(api_key))
